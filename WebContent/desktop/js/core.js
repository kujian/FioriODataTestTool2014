...
Core.menu={
    ...
    [{
        ...
        data: [[{
            text: "背景1",
            func: function() {
                $(this).attr("style",'background:url(desktop/imagesbackground.jpg) repeat right bottom transparent;');
            }
        }, {
            text: "背景2",
            func: function() {
                $(this).attr("style",'background:url(desktop/imagesbackground2.jpg) repeat right bottom transparent;');
            }       
        }]]
    }]
    ],
...
Core.create = function(obj,opt){    
    ...
    if(typeof(obj)==='string'){
        var options = {
            ...
            imgsrc	:"desktop/imagesshortcut/news.png",
            title	:opt.title,
            url		:opt.url,
            width	:opt.width,
            height	:opt.height,
