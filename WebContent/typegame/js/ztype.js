...
(function (window) {
    ...
    window.ig = {
        ...
        }, log: function () {}, assert: function (condition, msg) {}, show: function (name, number) {}, mark: function (msg, color) {}, _loadScript: function (name, requiredFrom) {
            ig.modules[name] = {
                name: name,
                requires: [],
                loaded: false,
...
ig.module('impact.entity').requires('impact.animation', 'impact.impact').defines(function () {
    ...
    ig.Entity = ig.Class.extend({
        ...
        }, check: function (other) {}, collideWith: function (other, axis) {}, ready: function () {}, erase: function () {}
    });
    ig.Entity._lastId = 0;
    ig.Entity.COLLIDES = {
        NEVER: 0,
...
ig.module('game.menus').requires('impact.font').defines(function () {
    MenuItem = ig.Class.extend({
        getText: function () {
            return 'none'
        }, left: function () {}, right: function () {}, ok: function () {}, click: function () {
            this.ok();
    ...
    Menu = ig.Class.extend({
        clearColor: null,
        name: null,
        font: new ig.Font('typegame/pic/tungsten-18.png'),
        fontSelected: new ig.Font('typegame/pic/tungsten-18-orange.png'),
        fontTitle: new ig.Font('typegame/pic/tungsten-48.png'),
        current: 0,
        itemClasses: [],
        items: [],
        init: function () {
...
ig.module('game.entities.enemy').requires('impact.entity', 'impact.font', 'game.words', 'game.entities.particle').defines(function () {
    EntityEnemy = ig.Entity.extend({
        ...
        currentLetter: 0,
        targeted: false,
        font: new ig.Font('typegame/pic/deja-vu-12.png'),
        fontActive: new ig.Font('typegame/pic/deja-vu-12-orange.png'),
        speed: 10,
        friction: {
            x: 100,
            y: 100
        ...
        soundHit: new ig.Sound('typegame/sounds/hit.ogg'),
    ...
    EntityExplosionParticle = EntityParticle.extend({
        ...
        animSheet: new ig.AnimationSheet('typegame/pic/explosion.png', 32, 32),
        init: function (x, y, settings) {
...
ig.module('game.entities.enemy-missle').requires('game.entities.enemy').defines(function () {
    EntityEnemyMissle = EntityEnemy.extend({
        ...
        animSheet: new ig.AnimationSheet('typegame/pic/missle.png', 20, 26),
        health: 4,
        speed: 35,
        targetTimer: null,
        wordLength: {
...
ig.module('game.entities.enemy-mine').requires('game.entities.enemy').defines(function () {
    EntityEnemyMine = EntityEnemy.extend({
        ...
        animSheet: new ig.AnimationSheet('typegame/pic/mine.png', 32, 32),
        speed: 30,
        health: 6,
        wordLength: {
            min: 3,
...
ig.module('game.entities.enemy-destroyer').requires('game.entities.enemy').defines(function () {
    EntityEnemyDestroyer = EntityEnemy.extend({
        ...
        animSheet: new ig.AnimationSheet('typegame/pic/destroyer.png', 43, 58),
        health: 8,
        speed: 20,
        shootTimer: null,
        wordLength: {
...
ig.module('game.entities.enemy-oppressor').requires('game.entities.enemy').defines(function () {
    EntityEnemyOppressor = EntityEnemy.extend({
        ...
        animSheet: new ig.AnimationSheet('typegame/pic/oppressor.png', 68, 88),
        health: 10,
        speed: 15,
        shootTimer: null,
        bullets: 16,
    ...
    EntityEnemyBullet = EntityEnemy.extend({
        ...
        animSheet: new ig.AnimationSheet('typegame/pic/bullet.png', 20, 24),
        health: 1,
        speed: 50,
        wordLength: {
            min: 1,
...
ig.module('game.entities.player').requires('impact.entity', 'game.entities.particle').defines(function () {
    EntityPlayer = ig.Entity.extend({
        animSheet: new ig.AnimationSheet('typegame/pic/ship.png', 24, 24),
        targetAngle: 0,
        size: {
            x: 8,
            y: 8
        ...
        angle: 0,
        targetAngle: 0,
        soundShoot: new ig.Sound('typegame/sounds/plasma.ogg'),
        soundMiss: new ig.Sound('typegame/sounds/click.ogg'),
        soundExplode: new ig.Sound('typegame/sounds/explosion.ogg'),
    ...
    EntityPlasma = ig.Entity.extend({
        ...
        animSheet: new ig.AnimationSheet('typegame/pic/plasma.png', 96, 96),
        size: {
            x: 4,
            y: 4
        },
...
ig.module('game.main').requires('impact.game', 'impact.font', 'game.menus', 'game.entities.enemy-missle', 'game.entities.enemy-mine', 'game.entities.enemy-destroyer', 'game.entities.enemy-oppressor', 'game.entities.player', 'plugins.impact-splash-loader').defines(function () {
    ...
    ZType = ig.Game.extend({
        font: new ig.Font('typegame/pic/tungsten-18.png'),
        fontScore: new ig.Font('typegame/pic/04b03-mono-digits.png'),
        fontTitle: new ig.Font('typegame/pic/tungsten-48.png'),
        fontSelected: new ig.Font('typegame/pic/tungsten-18-orange.png'),
        spawnTimer: null,
        targets: {},
        currentTarget: null,
        yScroll: 0,
        backdrop: new ig.Image('typegame/pic/backdrop.png'),
        grid: new ig.Image('typegame/pic/grid.png'),
        music: new ig.Sound('typegame/sounds/endure.ogg', false),
        menu: null,
        mode: 0,
        score: 0,
        streak: 0,
