$( function() {
    ...
    var trafficSound = new buzz.sound( 'fullscreengallery/sounds/traffic' ),
        clickSound = new buzz.sound( 'fullscreengallery/sounds/click' ),
        focusSound = new buzz.sound( 'fullscreengallery/sounds/focus' ),
        rewindSound = new buzz.sound( 'fullscreengallery/sounds/rewind' ),
