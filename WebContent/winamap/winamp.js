...
file = "winamap/music/see.mp3"
fileName = "1. DJ Mike Llama - Llama Whippin' Intro (0:05)";
winamp.loadFromUrl(file, fileName);

winamp.marqueeLoop();
var skinurl = "https://cdn.rawgit.com/captbaritone/winamp2-js/master/skins/base-2.91.wsz";
winamp.skinManager.setSkinByUrl("winamap/skins/base-2.91.wsz");
